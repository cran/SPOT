...
#' Supposed to be used for testing purpose only. Do not use.
#'
...
#' @keywords internal
#######################################################################
spotPredictTest <- function(rawB,mergedB,largeDesign,spotConfig,externalFit=NULL){	
	...
	else {stop("Unknown Test function for spotPredictTest. Please check testfunction, or change spotPredictTest accordingly")}
